...
<%
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        populationsizedao usfoodrepo = new populationsizedao();
        populationsize popobj = new populationsize(series_id,year,period,value);
        try {
            Boolean insertresult = usfoodrepo.insert_population(popobj);
