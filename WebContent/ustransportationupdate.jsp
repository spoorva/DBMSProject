...
--%>
<%@page import="dao.ustransportationdao"%>
<%@page import="dao.db_connect"%>
<%@page import="model.ustransportation"%>
...
<%
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        ustransportationdao ustransrepo = new ustransportationdao();
        ustransportation transobj = new ustransportation(series_id,year,period,value);
        try {
            Boolean updateresult = ustransrepo.update_ustransportation(transobj);
